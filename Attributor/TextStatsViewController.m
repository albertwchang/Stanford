...
- (void) viewDidLoad {
    [super viewDidLoad];
    self.textToAnalyze = [[NSAttributedString alloc] initWithString:@"testing" attributes:@{ NSForegroundColorAttributeName : [UIColor greenColor]} ];
...
- (void) updateUI {
    ...
    self.outlineCharacterLabel.text = [NSString stringWithFormat:@"%d outlined characters", [[self charactersWithAttribute:NSStrokeWidthAttributeName] length] ];
}
